...
path_to_m1_data='/home/paulsharp/Documents/projects/Eran_MomentumModelAnxiousMood_2018/Behavioral_Data/analyses_and_data/m1'
path_to_m2_data='/home/paulsharp/Documents/projects/Eran_MomentumModelAnxiousMood_2018/Behavioral_Data/analyses_and_data/m2'
...
df_T_scores_momentum.to_csv('Momentum_TScores_{}.csv'.format(tallies_past))
...
for sub in subs_m2:
	...
	#create regressors for outcomes i trials ago (1-5)
	...
	#calculate regressor outcome a la Browning et al (reference is Rock 1, regressor=1 if choose rock 1 and get shocked)
	for row in range(len(df_sub_m2)):
		if df_sub_m2[1][row]== 1:
			if df_sub_m2[0][row] == 2:
				regressor_outcome_given_choice.append(0)
			else:
				regressor_outcome_given_choice.append(df_sub_m1[1][row])
		else:
			regressor_outcome_given_choice.append(df_sub_m2[1][row])
...
df_T_scores_volatility.to_csv('Volatility_TScores_{}.csv'.format(tallies_past))
...
ax.set_title('Momentum {} Tallies {} Data'.format(tallies_past,data_type))
plt.show()
...
ax.set_title('Volatility with {} Tallies {} Data'.format(tallies_past,data_type))
plt.show()
